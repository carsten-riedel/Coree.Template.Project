...
- `Readme.md`, `ReleaseNotes.txt`, optional icon, and optional docs belong to the module distribution. `License.txt` belongs to the module distribution only for `ProjectLicense=Custom`.
