...
8. Solution notes under `src/wrk/*/Readme.md` do not contradict the layout you kept (solution under `src/` vs repository root, host-specific leftover instructions).
