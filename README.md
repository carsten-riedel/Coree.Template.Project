...
#wget --content-disposition -O code.deb https://go.microsoft.com/fwlink/?LinkID=760868 && sudo apt install -y ./code.deb && echo >>"$HOME/.bashrc" "export DONT_PROMPT_WSL_INSTALL=1"
```
