...
######################################################################################
Log-Block -Stage "Prebuild environment" -Section "Requirements" -Task "Commands setup."
...
######################################################################################
Log-Block -Stage "Prebuild environment" -Section "Requirements" -Task "Git setup."
...
######################################################################################
Log-Block -Stage "Prebuild environment" -Section "Requirements" -Task "Github setup."
