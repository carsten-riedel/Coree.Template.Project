...
6. Public surface has no leftover template samples (`AddTask`, DebugHost 5+3 demo, tests that do not assert the product, copyright lines that still lie).
